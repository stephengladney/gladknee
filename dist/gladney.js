...
exports.saveTextToFileInBrowser =
  ...
  exports.pauseSync =
  exports.pauseAsync =
  exports.addTimeoutToPromise =
  exports.convertQueryParamOperators =
  exports.createExpressRoutes =
  exports.convertObjectToQueryParams =
  exports.groupByKeyValue =
  exports.getKeyValueCounts =
  exports.sortByKeyValues =
  exports.sortByKeyValue =
  exports.sumOfKeyValue =
  exports.combineObjects =
  exports.pickKeys =
  exports.omitKeys =
  exports.areArraysEqual =
  exports.nthFromEnd =
  exports.getSharedItems =
  exports.getCommonItems =
  exports.getUniqueItems =
  exports.getCountOf =
  exports.getCounts =
  exports.getRollingSum =
  ...
  exports.timeSince =
  exports.timeUntil =
  exports.getAmountOfTimeFromSeconds =
  exports.ordinal =
  exports.getRange =
  exports.doubleDigit =
  exports.clampNumber =
  ...
  exports.float =
    void 0
exports.getBrowserLocationQueryParams =
  exports.getBrowserGeolocation =
  exports.createQueueAsync =
  exports.createQueue =
  exports.setCookie =
  exports.getCookie =
    void 0
...
function getKeyValueCounts(arr, key, isCaseSensitive) {
  return arr.reduce((result, obj) => {
    const value = isCaseSensitive ? obj[key] : obj[key].toLowerCase()
    if (result[value] > 0) {
 ...
 * ```
 **/
function groupByKeyValue(arr, key) {
  const result = {}
  arr.forEach((obj) => {
...
function createQueueAsync(functionToExecute) {
  ...
  const executeOne = () =>
    __awaiter(this, void 0, void 0, function* () {
      if (Array.isArray(queue[0])) yield functionToExecute(...queue[0])
      else yield functionToExecute(queue[0])
      queue.shift()
    })
  const executeAll = (ignoreErrors = false) =>
    __awaiter(this, void 0, void 0, function* () {
      if (isBreakRequested) return
      try {
        if (Array.isArray(queue[0])) yield functionToExecute(...queue[0])
...
function getBrowserLocationQueryParams() {
  ...
  return params.reduce((acc, param) => {
    ...
    } else return Object.assign(Object.assign({}, acc), { [key]: value })
  }, {})
}
