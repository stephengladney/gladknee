...
const _ = __importStar(require("./gladney"));
describe("numbers", () => {
    describe("float", () => {
...
describe("time & dates", () => {
    ...
    describe("timeUntil", () => {
        it("returns the correct number of seconds until the provided time", () => {
            ...
            const validResult1 = result.hours === 23 && result.minutes === 59 && result.seconds === 59;
            const validResult2 = result.days === 1 &&
                result.hours === 0 &&
                result.minutes === 0 &&
                result.seconds === 0;
    ...
    describe("timeSince", () => {
        it("returns the correct number of seconds until the provided time", () => {
            ...
            const validResult = result.days === 1 &&
                result.hours === 0 &&
                result.minutes === 0 &&
...
describe("strings", () => {
    ...
    describe("escapeString", () => {
        it("returns a string with characters escaped", () => {
            expect(_.escapeString("Hello <there>, my 'friend'")).toBe("Hello &lt;there&gt;, my &#x27;friend&#x27;");
        });
    });
    describe("unEscapeString", () => {
        it("returns a string with characters unescaped", () => {
            expect(_.unEscapeString("Hello &lt;there&gt;, my &#x27;friend&#x27;")).toBe("Hello <there>, my 'friend'");
        });
    });
});
describe("arrays", () => {
    ...
    describe("isEqual", () => {
        ...
        it("objects are equal out of order, order does matter", () => {
            expect(_.isEqual({ a: 1, b: 2, c: 3 }, { c: 3, b: 2, a: 1 }, true)).toBe(false);
        });
        it("objects are equal but diff case, case doesn't matter", () => {
            expect(_.isEqual({ a: "A", b: "B", c: "C" }, { a: "a", b: "b", c: "c" }, true, false)).toBe(true);
        });
        it("objects are equal but diff case, case does matter", () => {
            expect(_.isEqual({ a: "A", b: "B", c: "C" }, { a: "a", b: "b", c: "c" }, true, true)).toBe(false);
        });
        it("objects are equal but diff case and out of order, order and case don't matter", () => {
            expect(_.isEqual({ a: "A", b: "B", c: "C" }, { c: "c", a: "a", b: "b" }, false, false)).toBe(true);
        });
    });
    describe("safeSort", () => {
        it("sorts numbers", () => {
...
describe("misc", () => {
    describe("addTimeoutToPromise", () => {
        it("throws an error if timeout happens first", () => __awaiter(void 0, void 0, void 0, function* () {
            let err = "";
            let timer;
            const slowThing = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("returns the promise result if promise resolves happens first", () => __awaiter(void 0, void 0, void 0, function* () {
            let result;
            let err = "";
            let timer;
            const fastThing = () => __awaiter(void 0, void 0, void 0, function* () {
                return new Promise((resolve, reject) => {
            ...
            try {
                result = yield slowThingWithTimeout();
            }
            catch (e) {
                clearTimeout(timer);
                err = e;
    ...
    describe("pauseAsync", () => {
        it("pauses for the provided milliseconds", () => __awaiter(void 0, void 0, void 0, function* () {
            const start = Date.now();
            yield _.pauseAsync(500);
            const end = Date.now();
    ...
    describe("convertObjectToQueryParams", () => {
        ...
        it("handles nesting (last param)", () => {
            ...
            expect(_.convertObjectToQueryParams(obj)).toEqual("name=john&age=30&favorite[drink]=coke&favorite[food]=chicken");
        });
        it("handles nesting (middle param)", () => {
            ...
            expect(_.convertObjectToQueryParams(obj)).toEqual("name=john&favorite[drink]=coke&favorite[food]=chicken&age=30");
        });
    });
    describe("partial", () => {
    ...
    describe("debounce", () => {
        ...
        it("immediate = false. invokes the function after the delay but not before", () => __awaiter(void 0, void 0, void 0, function* () {
            const func = jest.fn();
        ...
        it("immediate = false. restarts the delay if the function is tried before the wait has passed", () => __awaiter(void 0, void 0, void 0, function* () {
            const func = jest.fn();
            const debouncedFunc = _.debounce(func, 500, false);
            debouncedFunc();
            debouncedFunc();
            expect(func).toHaveBeenCalledTimes(0);
            yield _.pauseAsync(200);
            expect(func).toHaveBeenCalledTimes(0);
            yield _.pauseAsync(300);
            expect(func).toHaveBeenCalledTimes(1);
        }));
        it("immediate = false. flush executes the function immediately", () => __awaiter(void 0, void 0, void 0, function* () {
            const func = jest.fn();
            const debouncedFunc = _.debounce(func, 500, false);
